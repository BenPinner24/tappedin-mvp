...
//
// If ?card_id=pvc-002 is present in the URL:
//   - Pass `next=/claim/pvc-002` as the email confirmation redirect so the
//     auth callback knows to send the user to the claim page after confirming.
//   - Show a small "Activating card: pvc-002" context hint in the UI.
...
function SignupContent() {
  ...
  async function handleSignup(e: React.FormEvent) {
    ...
    try {
      // Build the redirect URL: after email confirmation the callback will
      // receive ?next=/claim/pvc-002 and redirect there automatically.
