...
interface MultipackConfirmationEmailProps {
  customerName?: string
  orderNumber?: string
...
export function MultipackConfirmationEmail({
  customerName,
  orderNumber,
  packName,
  quantity,
}: MultipackConfirmationEmailProps) {
  ...
  const packLabel = packName || 'Multi-Pack'
  const qty = quantity || undefined
  const cardsValue = qty ? `${qty} cards` : 'Multiple cards'
  ...
  return (
    <html lang="en">
      <head>
        ...
        <title>Your TAPPED-IN Multi-Pack is confirmed</title>
      </head>
      <body style={wrapper}>
        ...
        >
          Your order is confirmed. Your TAPPED-IN Multi-Pack is being prepared for dispatch.
        </div>
                    ...
                    <tr>
                      <td style={heroCell}>
                        ...
                        <h1 style={heading}>
                          {greeting}
                          <br />
                          <span style={headingLight}>Your Multi-Pack is on its way.</span>
                        </h1>
                        <p style={lead}>
                          Thank you for your order. Your {packLabel}
                          {qty ? ` (${qty} PVC TAPPED-IN cards)` : ''} is being prepared
                          and will be dispatched shortly. Every card in your pack opens the
                          same profile, always in sync.
                        </p>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td style={detailsCell}>
                        ...
                        >
                          <tbody>
                            <tr>
                              <td style={detailRowLabel}>Pack</td>
                              <td style={detailRowValue}>{packLabel}</td>
                            </tr>
                            <tr>
                              <td style={detailRowLabel}>Cards</td>
                              <td style={detailRowValue}>{cardsValue}</td>
                            </tr>
                            {orderNumber ? (
                              <tr>
                    ...
                    <tr>
                      <td style={stepsCell}>
                        ...
                        <div style={stepBlock}>
                          ...
                          <p style={stepBody}>
                            We&apos;ll keep you informed by email as your pack is
                        ...
                        <div style={stepBlock}>
                          ...
                          <p style={stepTitle}>Set up your profile</p>
                          <p style={stepBody}>
                            When your cards arrive, tap the first card on your phone to
                            set up your profile — no app required.
                          </p>
                        </div>

                        <div style={{ ...stepBlock, ...stepBlockLast }}>
                          <p style={stepNumber}>Step 03</p>
                          <p style={stepTitle}>Add the rest</p>
                          <p style={stepBody}>
                            Tap each remaining card to link it to that same profile — one
                            in your wallet, one in your phone case, one on your desk. One
                            profile means one plan when subscriptions launch, never a fee
                            per card.
                          </p>
                        </div>
                      </td>
...
export default MultipackConfirmationEmail
